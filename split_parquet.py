...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default=os.path.join("datasets", "mdc_dataset.parquet"))
    parser.add_argument("--train_out", type=str, default=os.path.join("datasets", "train.parquet"))
    parser.add_argument("--val_out", type=str, default=os.path.join("datasets", "val.parquet"))
